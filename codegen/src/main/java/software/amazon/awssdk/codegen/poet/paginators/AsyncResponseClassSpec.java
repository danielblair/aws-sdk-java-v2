 ...
 */
public class AsyncResponseClassSpec implements ClassSpec {

    private static final Logger log = LoggerFactory.getLogger(AsyncResponseClassSpec.class);
    ...
    public AsyncResponseClassSpec(IntermediateModel intermediateModel,
    ...
    /**
     * @return A Poet {@link ClassName} for the operation response type.
     *
